...
class ModernSidebar {
    ...
    createSidebar() {
        ...
        sidebar.innerHTML = `
            ...
            <div class="sidebar-quick-actions">
                <button class="quick-action-btn" data-action="theme" title="Zmień motyw">
                    <i class="fas fa-moon"></i>
                </button>
                <button class="quick-action-btn" data-action="language" title="Zmień język">
                    <i class="fas fa-globe"></i>
                </button>
                <button class="quick-action-btn auth-action-btn" data-action="auth" title="Zaloguj">
            ...
            <div class="sidebar-user-bottom">
                <div class="user-avatar" data-action="profile" title="Profil użytkownika">
    ...
    initializeExistingElements() {
        ...
        this.authButton = this.sidebar.querySelector('.sidebar-auth-btn');
    ...
    setupEventListeners() {
        ...
        // User section click - navigate to profile
        if (this.userSection) {
            this.userSection.addEventListener('click', (e) => {
                // Don't trigger if auth button was clicked
                if (!e.target.closest('.sidebar-auth-btn')) {
    ...
    handleUserClick() {
        // Navigate to profile when user section is clicked (except auth button)
        if (this.currentUser && this.currentUser.isLoggedIn) {
            this.navigateToProfile();
        } else {
            // If not logged in, clicking user section shows auth modal
            this.handleAuthClick();
        }
    }
    ...
    updateUserDisplay(user) {
        ...
        const authButton = this.sidebar.querySelector('.sidebar-auth-btn');
