    ...
    createSidebar() {
        ...
        sidebar.innerHTML = `
            ...
            <nav class="sidebar-nav">
                <div class="nav-section">
                    ...
                    <a href="#" class="nav-item" data-action="profile">
                        ...
                        <span class="nav-item-text" data-translate="sidebar.profile">Profil</span>
                    </a>
                </div>
            ...
            <div class="sidebar-user-bottom">
                ...
                <button class="sidebar-auth-btn" aria-label="Login/Logout">
        ...
        // Hide sidebar initially and set collapsed state
