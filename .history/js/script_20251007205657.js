...
function toggleDarkMode() {
    ...
    try { 
        ...
        console.log('Saved dark mode to localStorage:', darkMode ? '1' : '0');
    } catch (e) {
    ...
    if (typeof updateDashboardThemeBtn === 'function') {
        ...
        console.log('Updated dashboard theme button');
    } else {
        console.warn('updateDashboardThemeBtn function not found');
    }
}
...
function updateDashboardThemeBtn() {
    if (!translations[currentLang] || !translations[currentLang].dashboard) return;
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Update mobile dashboard theme button on load
    if (typeof updateDashboardThemeBtn === 'function') {
        updateDashboardThemeBtn();
    }
