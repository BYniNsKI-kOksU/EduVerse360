...
class AuthSystem {
            ...
            <div class="auth-modal">
                <div class="auth-modal-header">
                    <div class="auth-modal-title">
                        <span id="authModalTitle" data-translate-key="auth.modalTitle">Witaj ponownie!</span>
                        <span class="auth-modal-subtitle" data-translate-key="auth.modalSubtitle">Zaloguj się lub utwórz nowe konto</span>
                    </div>
                ...
                <div class="auth-modal-content">
                    ...
                    <!-- Login Form -->
                        ...
                        <div class="form-group">
                            <label for="loginEmail" data-translate-key="auth.email">Email:</label>
                                <input type="email" id="loginEmail" data-translate-placeholder="auth.emailPlaceholder" placeholder="twoj@email.com" required>
                        </div>
                        <div class="form-group">
                            <label for="loginPassword" data-translate-key="auth.password">Hasło:</label>
                            <div class="password-input-wrapper">
                                    <input type="password" id="loginPassword" data-translate-placeholder="auth.passwordPlaceholder" placeholder="••••••••" required>
                        ...
                        <button type="submit" class="auth-submit-btn">
                            <i class="fas fa-sign-in-alt"></i>
                                <span data-translate-key="auth.loginButton">Zaloguj się</span>
                        </button>
                            <div class="auth-switch-link">
                                <span data-translate-key="auth.noAccount">Nie masz konta? </span>
                                <a href="#" onclick="authSystem.switchAuthTab('register'); return false;" data-translate-key="auth.register">Zarejestruj się</a>
                            </div>
                    </form>
                    ...
                    <!-- Register Form -->
                        ...
                        <div class="form-group">
                                <label for="registerUsername" data-translate-key="auth.username">Nazwa użytkownika:</label>
                                <input type="text" id="registerUsername" data-translate-placeholder="auth.usernamePlaceholder" placeholder="Twoja nazwa" required>
                        </div>
                        <div class="form-group">
                            <label for="registerEmail" data-translate-key="auth.email">Email:</label>
                                <input type="email" id="registerEmail" data-translate-placeholder="auth.emailPlaceholder" placeholder="twoj@email.com" required>
                        </div>
                        <div class="form-group">
                            <label for="registerPassword" data-translate-key="auth.password">Hasło:</label>
                            <div class="password-input-wrapper">
                                    <input type="password" id="registerPassword" data-translate-placeholder="auth.minPasswordPlaceholder" placeholder="Min. 6 znaków" required minlength="6">
                        ...
                        <div class="form-group">
                            <label for="registerConfirmPassword" data-translate-key="auth.confirmPassword">Potwierdź hasło:</label>
                            <div class="password-input-wrapper">
                                    <input type="password" id="registerConfirmPassword" data-translate-placeholder="auth.repeatPasswordPlaceholder" placeholder="Powtórz hasło" required minlength="6">
                        ...
                        <button type="submit" class="auth-submit-btn">
                            <i class="fas fa-user-plus"></i>
                                <span data-translate-key="auth.registerButton">Zarejestruj się</span>
                        </button>
                            <div class="auth-switch-link">
                                <span data-translate-key="auth.hasAccount">Masz już konto? </span>
                                <a href="#" onclick="authSystem.switchAuthTab('login'); return false;" data-translate-key="auth.login">Zaloguj się</a>
                            </div>
                    </form>
                    </div>
    ...
    switchAuthTab(tabType) {
        ...
        // Sprawdź przewijalność po zmianie formularza
        setTimeout(() => {
            this.checkScrollability();
        }, 100);
    }
    ...
    // Aktualizuj tłumaczenia modala autoryzacji
    updateAuthTranslations() {
        ...
        // Aktualizuj wszystkie elementy z data-translate-key
        modal.querySelectorAll('[data-translate-key]').forEach(element => {
