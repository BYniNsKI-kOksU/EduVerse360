        ...
        if (isAdvanced) {
            return {
                ...
                <div class="help-section">
                    ...
                    <p>Tryb rozszerzony kalkulatora macierzy umożliwia wykonywanie zaawansowanych operacji na macierzach, takich jak ślad, rząd, ranga czy wartości własne. Pozwala to na głębszą analizę struktur macierzowych i rozwiązywanie bardziej złożonych problemów matematycznych.</p>
                </div>
                <div class="help-section">
                    ...
                    <ul class="help-list">
                        ...
                        <li><b>Rząd macierzy</b> – liczba liniowo niezależnych wierszy</li>
                        <li><b>Ranga macierzy</b> – liczba niezerowych wierszy po eliminacji Gaussa</li>
                        <li><b>Wartości własne</b> – liczby charakterystyczne macierzy kwadratowej</li>
                    </ul>
                </div>
                <div class="help-section">
                    <h3><i class="fas fa-lightbulb"></i> Przykłady użycia</h3>
                    <ul class="help-list">
                        <li>Oblicz ślad macierzy 3x3: wybierz "Ślad macierzy", wprowadź dane i kliknij Oblicz.</li>
                        <li>Wyznacz rząd macierzy: wybierz "Rząd macierzy", podaj macierz dowolnych wymiarów.</li>
                        <li>Sprawdź wartości własne: wybierz "Wartości własne" dla macierzy kwadratowej.</li>
                    </ul>
                </div>
                <div class="help-section">
